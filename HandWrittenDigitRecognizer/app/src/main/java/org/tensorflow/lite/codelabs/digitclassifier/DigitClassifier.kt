...
class DigitClassifier(private val context: Context) {
  ...
  private fun initializeInterpreter() {
    ...
    Log.d(TAG, Arrays.toString(inputShape))
    inputImageWidth = 28 // inputShape[1]
    inputImageHeight = 28 // inputShape[2]
    modelInputSize = FLOAT_TYPE_SIZE * inputImageWidth * inputImageHeight * PIXEL_SIZE
//    modelInputSize = FLOAT_TYPE_SIZE * inputShape[1] * PIXEL_SIZE
    Log.d(TAG, "modelInputSize="+modelInputSize)
  ...
  private fun classify(bitmap: Bitmap): String {
    ...
    Log.d(TAG, Arrays.toString(output[0]))
    val result = output[0]
